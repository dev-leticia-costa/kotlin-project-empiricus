...
class SecurityConfig() {
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain? {
        ...
        http.httpBasic().and()
            ...
            .antMatchers(HttpMethod.POST, "/movement/save").authenticated()
            .antMatchers(HttpMethod.DELETE, "/movement/{idMovement}").authenticated()
            .antMatchers(HttpMethod.DELETE, "/movement/all").authenticated()
            .antMatchers(HttpMethod.PUT, "/movement/{idMovement}").authenticated()
            .antMatchers(HttpMethod.GET, "/movement/filter").authenticated()
